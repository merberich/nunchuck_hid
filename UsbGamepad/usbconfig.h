...
//!
//! Modified: 2017
//! Selects PD3 as USB_DMINUS and PD2 as USB_DPLUS.
//! Uses VOTI FREE LAB-USE VID/PID pair.
//! Changes vendor and description to project-appropriate names.
//! M. Erberich
...
// PID = VOTI FREE LAB-USE VID (0x1000)
#define  USB_CFG_DEVICE_ID       0x00, 0x10
...
#define USB_CFG_VENDOR_NAME     'M','.','E','r','b','e','r','i','c','h'
...
#define USB_CFG_DEVICE_NAME     'N','u','n','c','h','u','c','k','H','I','D'
